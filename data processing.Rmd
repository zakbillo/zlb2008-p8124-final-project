...
Only separate the dataset into asthmatics and non-asthmatics
...
dim(X_asthma)  # Exactly 258 samples x 934 probes
dim(X_normal)  # Exactly 134 samples x 934 probes
